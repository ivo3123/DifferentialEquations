...
$$\begin{pmatrix}y_1(x) & \cdots & y_k(x)\newline y_1^{(1)}(x_0) & \cdots & y_k^{(1)}(x_0)\newline\vdots  & \ddots & \vdots\newline y_1^{(k-1)}(x_0) & \cdots & y_k^{(k-1)}(x_0)\end{pmatrix}\begin{pmatrix}C_1\newline C_2\newline\vdots\newline C_k\end{pmatrix}
$$
