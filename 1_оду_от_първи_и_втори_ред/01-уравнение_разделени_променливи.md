...
Изразяваме $y$ като функция на $x$ в явен вид, ако е възможно.
...
Взимаме обратната функция на $\arctan{y}$

$$y = \tan(x^2 + C) \qquad x^2 + C \in \left(-\dfrac{\pi}{2}, \dfrac{\pi}{2}\right)$$
